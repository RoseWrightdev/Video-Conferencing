...
const (
	SummaryService_Summarize_FullMethodName = "/summary_service.SummaryService/Summarize"
)
...
var SummaryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "summary_service.SummaryService",
	...
	Metadata: "proto/summary-service.proto",
}
